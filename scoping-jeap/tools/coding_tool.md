...
The extraction form on the [main page](../index.html) describes what is recorded for each item and why. This page briefly describes the [html tool](tools/coding_tool.html) I used to support the extraction process.
